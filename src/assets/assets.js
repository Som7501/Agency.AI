...
export const servicesData = [
  {
    ...
    description: 'Craft compelling content that resonates with your audience and drives conversions across all digital platforms.',
    icon: content_icon,
  },
  {
    title: 'Social Media Marketing',
    description: 'Boost your brand presence and engage with your audience through targeted social media campaigns and strategies.',
    icon: social_icon,
  },
  {
    title: 'Digital Advertising',
    description: 'Maximize your ROI with data-driven digital advertising strategies across multiple platforms and digital channels.',
    icon: ads_icon,
  },
  {
    title: 'Marketing Strategy',
    description: 'Develop comprehensive marketing strategies tailored to your specific business goals and target audience needs.',
    icon: marketing_icon,
  },
];
...
export const workData = [
  {
    ...
    description: 'A sleek and user-friendly mobile app designed to enhance user engagement and streamline navigation.',
    image: work_mobile_app,
  },
  {
    title: 'Fitness Tracker App',
    description: 'An innovative fitness tracker app that helps users monitor their health and achieve their fitness goals.',
    image: work_fitness_app,
  },
  {
    title: 'Dashboard Management System',
    description: 'A comprehensive dashboard management system that provides real-time insights and analytics for better decision-making.',
