...
const ContactUs = () => {
    ...
    // Web3Form website for sending message via email
    ...
    formData.append("access_key", "6ba92eb8-2e44-49b5-99e7-1320fbe851c6");
  ...
  return (
    ...
    lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
       ...
       desc="From strtegy to execution, we craft digital solutions that 
